          ...
          <div className="projects-grid">
            <div className="project-card">
              ...
              <p>
                ...
                handling, and AI-powered company matching. Tech Stack: React •
                Node.js • MongoDB • SOA
              </p>
            ...
            <div className="project-card">
              ...
              <p>
                ...
                centralized dashboard. Tech Stack: React • Node.js • MongoDB
              </p>
            ...
            <div className="project-card">
              ...
              <p>
                ...
                advanced data structures. Tech Stack: Java • AVL Tree • Linked
                List
              </p>
              <a className="btn" href="#">
                View Project
